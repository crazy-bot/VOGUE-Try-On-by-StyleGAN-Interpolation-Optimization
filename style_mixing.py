...
def get_arg_parser():
    ...
    parser.add_argument('--rows', default=[85,100,75,458,1500])
    parser.add_argument('--cols', default=[55,821,1789,293])
    parser.add_argument('--styles', default=[0-6])
...
if __name__ == "__main__":
    ...
    generate_style_mix(args.network, args.rows, args.cols, args.styles, args.trunc, args.noise_mode, args.outdir) 
